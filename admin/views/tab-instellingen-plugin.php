...
<div class="cmcalc-settings-grid">
    ...
    <div class="cmcalc-settings-card" style="grid-column: 1 / -1;">
        ...
        <div id="cmcalcSmtpFields" class="cmcalc-settings-fields-grid" style="<?php echo $smtp['enabled'] ? '' : 'opacity:.5;pointer-events:none;'; ?>">
            ...
            <div class="cmcalc-settings-field">
                <label for="cmcalcSmtpPort">Poort &amp; versleuteling</label>
    ...
    <div class="cmcalc-settings-card" style="grid-column: 1 / -1;">
        ...
        <div style="display:flex;gap:10px;margin-top:18px;align-items:center;">
            <button type="button" class="button cmcalc-btn-primary" id="cmcalcSaveEmail">Opslaan</button>
    ...
    <div class="cmcalc-settings-card">
        ...
        <p class="description" style="margin-top:8px;font-size:12px;">
            Shortcode: <code>[cmcalc_portal]</code> &bull; Boekingslinks worden automatisch meegestuurd in bevestigingsemails.
        </p>
    ...
    <div class="cmcalc-settings-card">
        ...
        <div style="display:flex;gap:10px;margin-top:18px;align-items:center;">
            <button type="button" class="button cmcalc-btn-primary" id="cmcalcSaveGithubToken">Opslaan</button>
            <button type="button" class="button" id="cmcalcTestUpdate">🔄 Check nu op updates</button>
